...
//     [SerializeField] private FirebaseStorage storage;
...
//     public void ModelFileDownloader(GetModelManager modelData)
//     {
//         StorageReference reference = storage.GetReference(modelData.modelURL);
//         string filePath = Application.dataPath + $"model/{modelData.modelName + modelData.modelID}.{modelData.fileFormat}";
...
//         });
//     }
//     public void ImageFileDownloader(GetImageManager imageData)
//     {
//         Debug.Log($"{imageData.imageURL}");
//         StorageReference reference = storage.GetReferenceFromUrl(imageData.imageURL);
//         string filePath = Application.dataPath + $"image/{imageData.imageName + imageData.imageID}.{imageData.fileFormat}";
//         reference.GetFileAsync(filePath).ContinueWithOnMainThread(task =>
//         {
//             if (!task.IsFaulted && !task.IsCanceled)
//             {
